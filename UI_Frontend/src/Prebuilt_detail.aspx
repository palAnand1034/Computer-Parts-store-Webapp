<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Prebuilt_detail.aspx.cs" Inherits="Comp_peri_ecomm.Prebuilt_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="details col-md-6">
                        ...
                        <h4 class="price">current price: <span>
							<asp:Label ID="lblPrice" runat="server" Text=""></asp:Label></span></h4>
    ...
    <div class="product-box">
        <asp:Repeater ID="rptProducts" runat="server">
            <ItemTemplate>
                <asp:HyperLink ID="lnkProductDetail" runat="server" NavigateUrl='<%# Eval("PcID", "~/Prebu.aspx?productId={0}") %>'>
                    <asp:Image ID="imgProduct" runat="server" ImageUrl='<%# Eval("ImageUrl") %>' AlternateText='<%# Eval("PCName") %>' />
                    <h2><%# Eval("PCName") %></h2>
