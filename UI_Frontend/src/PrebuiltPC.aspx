<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PrebuiltPC.aspx.cs" Inherits="Comp_peri_ecomm.PrebuitPC" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Header" runat="server">
    <style>
        /* Updated styles for the table-based layout */
        .product-list {
            display: flex;
            flex-wrap: wrap;
